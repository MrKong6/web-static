...
class Form extends React.Component {
  constructor(props) {
    ...
    this.FUNC_ADMIN_FIVE = "12";
    this.FUNC_SYSTEM = "7,9,10,11,12";
    this.RANK_ADMIN = 4;
    this.RANK_MANGER = 1;
    ...
    const request = async () => {
      try {
        ...
        funcDic = funcDic.filter(func => (func.cId === func.cRootId && func.cId !== this.FUNC_ADMIN
            && func.cId !== this.FUNC_ADMIN_TWO && func.cId !== this.FUNC_ADMIN_THREE && func.cId !== this.FUNC_ADMIN_FOUR && func.cId !== this.FUNC_ADMIN_FIVE && func.cId !== "8"));
