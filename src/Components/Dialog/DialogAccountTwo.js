...
class DialogAccountTwo extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <form ref={(dom) => {
                ...
                <div id="accountViewTwo" className="modal fade" tabIndex="-1" role="dialog">
                            ...
                            <div className="modal-body">
                                ...
                                <div id="pay">
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-6">
                                            <Input placeholder="请输入金额" name={"outcome"} readOnly={true} />
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group row">
...
export default DialogAccountTwo;