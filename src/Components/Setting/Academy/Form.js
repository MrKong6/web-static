        ...
        const request = async () => {
            try {
                ...
                if (this.props.isEditor) {
                    ...
                    data = data.data
                    let moneyList = [],oneAmount = data.fields ? data.fields[0].classHour : 0;
                    if(data.fields){
                                ...
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-2">
                                                <Button type="primary" icon="plus" onClick={this.addPayItem} disabled={this.props.isEditor}></Button>
                                            </div>
                                        </div>
