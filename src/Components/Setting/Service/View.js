...
const NextBtn = ({id, ids}) => {
    ...
    return (
        <Link
            ...
            to={{
                pathname: `/academy/course/${ids[curIndex + 1]}`,
                state: {ids: ids}
            }}
        >
            下一条
...
class View extends React.Component {
    ...
    modAction() {
        this.props.history.push(`${this.props.match.url}/edit`, {
            selectedCou: this.state.data.courseTypeId,
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        <div className="col">
                                            ...
                                            <div className="form-group row">
                                                <label className="col-5 col-form-label font-weight-bold">每周课时</label>
                                                <div className="col-7">
                                                    <input
                                                        type="text"
                                                        readOnly={true}
                                                        className="form-control-plaintext"
                                                        value={this.state.data.classHourPerWeek}
                                                    />
                                                </div>
                                            </div>
                                            <div className="form-group row">
                                                <label className="col-5 col-form-label font-weight-bold">每周课次</label>
                                                <div className="col-7">
                                                    <input
                                                        type="text"
                                                        readOnly={true}
                                                        className="form-control-plaintext"
                                                        value={this.state.data.classTimePerWeek}
                                                    />
                                                </div>
                                            </div>
                                            <div className="form-group row">
                                                        ...
                                                        <div className="col-3">
                                                            <div className="form-group row">
                                                                ...
                                                                <input type="text" className="form-control"
                                                                       name={evt.clsName}
                                                                       placeholder="请输入课时数" value={evt.classHour}
                                                                       readOnly={true}/>
                                                            </div>
                                                        </div>
                                                    </div>
