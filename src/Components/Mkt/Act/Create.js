...
class Create extends React.Component {
    ...
    create() {
        ...
        query.parentId = this.props.location.state.checkId;
        if (query.startDate) {
            query.startDate = query.startDate.getTime();
        }
        if (query.endDate) {
            query.endDate = query.endDate.getTime();
        }
            ...
            <div>
                ...
                <div id="main" className="main p-3">
                    ...
                    <Form
                        ...
                        checkId={this.props.location.state.checkId}
                        checkName={this.props.location.state.checkName}
