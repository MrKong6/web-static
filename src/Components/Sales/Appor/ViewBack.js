...
class View extends React.Component {
    ...
    queryOpporInfo(){
        const request = async () => {
            try {
                let data = await ajax('/sales/oppor/queryById.do', {id: this.state.id});
                if (data && data.courseId) {
                    data.courseId = Number(data.courseId);
                }

                let oneTab = {},twoTab = {}, editVo={};
                if(data && data.courseTypes){
                    ...
                    <div className="row justify-content-md-center">
                        <div className="col col-8">
                            <div className="card">
                                <div className="card-body">
                                    <div className="col-12">
                                        <div className="row">
                                            <div className="col-2 fontTitle">机会信息</div>
                            ...
                            <div className="card" style={{"marginTop":"10px"}}>
                                <div className="card-body">
                                    <div className="col-12">
                                        <div className="row">
                                            <div className="col-2 fontTitle">机会进程</div>
                                            <div className="col-7"></div>
                        ...
                        <div className="col-4">
                            <ContactList
                                id={this.state.id}
                                canEdit={false}
                                groupName={this.props.changedCrmGroup.name}
                                ...
                                <div className="form-group row contact" id="addView">
                                    <form ref={(dom) => {
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-7">
                                                <Status typeId={this.state.typeId} />
                                            </div>
                                        </div>
                                    </form>
                                </div>
