                                ...
                                <div className="card-body">
                                    ...
                                    <div className="row">
                                        <div className="col">
                                            ...
                                            <div className="form-group row">
                                                <label className="col-5 col-form-label font-weight-bold">合同日期</label>
                                                <div className="col-7">
                                                    <input
                                                        type="text"
                                                        readOnly={true}
                                            ...
                                            <div className="form-group row">
                                                <label className="col-5 col-form-label font-weight-bold">合同状态</label>
                                                <div className="col-7">
                                                    <input
                                                        type="text"
                                                        readOnly={true}
                                                        className="form-control-plaintext"
                                                        value={this.state.data.contractStatusName}
                                                    />
                                                </div>
                                            </div>
                                            <div className="form-group row">
                                                <label className="col-5 col-form-label font-weight-bold">(学员合同状态)</label>
                                                <div className="col-7">
                                                    <input
                                                        type="text"
                                                        readOnly={true}
                                                        className="form-control-plaintext"
                                                        value={this.state.data.contractStuStatusName}
                                                    />
                                                </div>
                                            </div>
                                            <div className="form-group row">
                                        ...
                                        <div className="col">
                                            ...
                                            <div className="form-group row">
                                                <label className="col-5 col-form-label font-weight-bold">时长</label>
                                                <div className="col-7">
                                                    <input
                                                        type="text"
                                                        readOnly={true}
                                            ...
                                            <div className="form-group row">
                                                <label className="col-5 col-form-label font-weight-bold">培训资料费</label>
                                                <div className="col-7">
                                                    <input
                                                        type="text"
                                                        readOnly={true}
                                            ...
                                            <div className="form-group row">
                                                <label className="col-5 col-form-label font-weight-bold">其他费用</label>
                                                <div className="col-7">
                                                    <input
                                                        type="text"
                                                        readOnly={true}
                                                        className="form-control-plaintext"
                                                        value={this.state.data.otherPrice}
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="form-group row">
                                                ...
                                                <div className="col-7">
                                                    <input
                                                        ...
                                                        readOnly={true}
                                                        className="form-control-plaintext"
                                                        value={this.state.data.contractPrice}
                                                    />
                                                </div>
                                            </div>
                                            <div className="form-group row">
